...
public class ModelGoblinGulg extends ModelBase {
   ...
   public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
      ...
      if(super.onGround > -9990.0F) {
         ...
         float entityDemon = MathHelper.sin(super.onGround * 3.1415927F) * -(this.bipedHead.rotateAngleX - 0.7F) * 0.75F;
         this.bipedRightArm.rotateAngleX = (float)((double)this.bipedRightArm.rotateAngleX - ((double)f7 * 1.2D + (double)entityDemon));
      ...
      EntityGoblinGulg entityDemon1 = (EntityGoblinGulg)entity;
      int i = entityDemon1.getAttackTimer();
      if(i > 0) {
         this.bipedRightArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a((float)i - par4, 10.0F);
      }
