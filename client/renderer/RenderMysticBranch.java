...
public class RenderMysticBranch implements IItemRenderer {
   ...
   protected ModelMysticBranch model = new ModelMysticBranch();
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object ... data) {
      ...
      case 2:
         ...
         GL11.glTranslatef((float)this.tx - 0.08F, (float)this.ty + 0.25F, (float)this.tz + 0.1F);
   ...
   // $FF: synthetic class
   static class NamelessClass1163780673 {
