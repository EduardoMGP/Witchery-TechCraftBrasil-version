...
public class RenderGoblinGulg extends RenderLiving {
   ...
   protected void func_82421_b() {
      this.field_82423_g = new ModelGoblinGulg(1.0F);
      this.field_82425_h = new ModelGoblinGulg(0.5F);
   }
   ...
   protected int shouldRenderPass(EntityLiving par1EntityLiving, int par2, float par3) {
      ...
      if(itemstack != null) {
         ...
         if(item instanceof ItemArmor) {
            ...
            ModelGoblinGulg modelbiped = par2 == 2?this.field_82425_h:this.field_82423_g;
   ...
   public void doRender(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
      GL11.glColor3f(1.0F, 1.0F, 1.0F);
      BossStatus.setBossStatus((EntityGoblinGulg)par1EntityLiving, true);
