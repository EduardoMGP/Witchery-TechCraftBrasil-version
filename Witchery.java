...
public class Witchery {
   ...
   public void preInit(FMLPreInitializationEvent event) {
      ...
      try {
         ...
         String applicationId = "675814818640298004";
         String steamId = "";
         ...
         presence.state = "Seu servidor com mods";
         presence.details = "Site: techcraftbrasil.com.br";
         presence.largeImageKey = "logo-tech";
