...
public class RecipeShapelessPoppet implements IRecipe {
   ...
   public ItemStack getCraftingResult(InventoryCrafting inv) {
      ...
      for(int index = 1; recipePoppet < inv.getSizeInventory(); ++recipePoppet) {
         ItemStack stack = inv.getStackInSlot(recipePoppet);
      ...
      ItemStack var6 = this.findRecipeItemStack(inv, Witchery.Items.POPPET);
      if(var6 != null) {
         Witchery.Items.POPPET.addDamageToPoppet(var6, newPoppet);
      }
